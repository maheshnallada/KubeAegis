...
#   - Fallback: primary @rag/openai/gpt-oss-120b → @brag/llama-3.1-8b-instant on failure
...
# Use a saved dashboard config (pc-...) when available — some Portkey orgs set
# block_inline_config, which rejects the inline GATEWAY_CONFIG dict with a 400.
