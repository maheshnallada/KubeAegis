...
rails:
  dialog:
    user_messages:
      # openai/gpt-oss-120b is a chat/safety-tuned model — it ignores the classic
      # "User intent: ..." completion-style prompt and just answers conversationally,
      # so LLM-based canonical form matching never triggers a flow. Embeddings-only
      # matching classifies intent via similarity to the examples above instead,
      # bypassing the LLM for this step entirely.
