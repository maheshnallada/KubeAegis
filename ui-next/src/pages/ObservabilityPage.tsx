...
function ToolSection({ tool }: { tool: (typeof TOOLS)[number] }) {
  ...
  return (
    <section id={tool.id} className="scroll-mt-20">
      ...
      {/* What you can see */}
      <div className="mb-6 sm:mb-8 p-4 rounded-xl border border-[#2a2a3a] bg-[#0d0d14]">
      ...
      {/* Screenshots — 1-col on mobile, side by side on md+ */}
    ...
    <main className="pt-14">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-[#f1f1f5] mb-4">
            Full-stack visibility into every query
          </h1>
          <p className="text-[#5a5a72] text-sm sm:text-base leading-relaxed max-w-2xl mb-8">
          ...
          {/* Quick-jump pills — wrap on all screen sizes */}
        ...
        {/* ── Footer CTA ── */}
        <div className="mt-16 sm:mt-20 pt-8 sm:pt-10 border-t border-[#2a2a3a] flex flex-col sm:flex-row
